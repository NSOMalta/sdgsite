...
opensdg.chartColors = function(indicatorId) {
  ...
  var customColorList = ["D32F2F","4CAF50","7B1FA2","1976D2","FFEB3B","795548","FF9800","E91E63","512DA8","CDDC39","455A64","FF5722","42d4f4","aaffc3","800000"];
...
var mapView = function () {
  ...
  this.initialise = function(indicatorId, precision, precisionItems, decimalSeparator, dataSchema, viewHelpers, modelHelpers, chartTitles, startValues, proxy, proxySerieses) {
    ...
    $('#map').sdgMap({
      ...
      mapOptions: {"disaggregation_controls":false,"minZoom":10,"maxZoom":20,"tileURL":"https://server.arcgisonline.com/ArcGIS/rest/services/World_Topo_Map/MapServer/tile/{z}/{y}/{x}","tileOptions":{"id":"","accessToken":"","attribution":"Tiles &copy; Esri &mdash; Esri, DeLorme, NAVTEQ, TomTom, Intermap, iPC, USGS, FAO, NPS, NRCAN, GeoBase, Kadaster NL, Ordnance Survey, Esri Japan, METI, Esri China (Hong Kong), and the GIS User Community"},"colorRange":"chroma.brewer.YlOrRd","noValueColor":"#f0f0f0","styleNormal":{"weight":1,"opacity":1,"fillOpacity":0.7,"color":"#888888","dashArray":""},"styleHighlighted":{"weight":1,"opacity":1,"fillOpacity":0.7,"color":"#111111","dashArray":""},"styleStatic":{"weight":2,"opacity":1,"fillOpacity":0,"color":"#172d44","dashArray":"5,5"}},
            ...
            options: {
                scales: {
                    y: {
                        ...
                        ticks: {
                          stepSize: info.graphLimits.stepSize
                        }
                    }
                }
            }
